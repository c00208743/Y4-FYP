...
class PyGamePlayer(object):
    ...
    def get_observation(self):
        """
        Called whenever after the agent chooses an action to observe the new game state
        :param self: ...
        :return: remembers actions and game states
        """
        raise NotImplementedError("Please override this method")
    ...
    def get_score_at_the_end(self):
        ...
        :param self: ...
        :return: compiles data collected with score that was achieved
        """
        raise NotImplementedError("Please override this method")
    ...
    def _on_screen_update(self, _, *args, **kwargs):
        ...
        score = self.get_score_at_the_end()
