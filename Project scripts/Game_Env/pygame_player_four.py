...
class PyGamePlayer(object):
    ...
    def get_state(self):
        """
        Called whenever the screen buffer is refreshed. returns the current state of the game
        :return: a list of the integer values for the cart position, cart velocity, pole angle and pole velocity.
        """
    ...
    def get_new_state(self):
        """
        Called after the get_keys_pressed gets the new action. returns the current state of the game
        :return: a list of the integer values for the cart position, cart velocity, pole angle and pole velocity.
        """
        raise NotImplementedError("Please override this method")
    ...
    def pg_learn(self):
        """
        After recieving the new state from an action return the current state of the game then incorporate the pg evlaution
        :return: a list of the integer values for the cart position, cart velocity, pole angle and pole velocity.
        """
        raise NotImplementedError("Please override this method")
